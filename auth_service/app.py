...
# IMPORTANTE: reemplaza el URI con tu contraseña real, sin < ni >
MONGO_URI = os.environ.get('MONGO_URI', 'mongodb+srv://2023171060:85df2Bs9aVBi6VpH@cluster0.qyf53xx.mongodb.net/auth_db?retryWrites=true&w=majority&appName=Cluster0')
