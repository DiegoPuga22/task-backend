...
def insert_tasks_if_not_exists():
    ...
    tasks = [
        ('name1', 'first task', '2002-06-03', '2002-06-10', 'Completed', 1, 'Rusev'),
        ('name2', 'second task', '2004-04-04', '2004-04-14', 'Paused', 1, 'Roman')
    ]
...
# Ruta para obtener una tarea por ID se require el id
